convert.CRUNCEP <- function(directory,
  ...
  for (year in year_seq) {
    ...
    write_ed_metheader(ed_metheader,file.path(directory, "ED_MET_DRIVER_HEADER"),
                       header_line = shQuote("Made_by_PEcAn_met2model.ED2"))
  }
  PEcAn.logger::logger.info("Done with met2model.ED2")
}

# scp /home/femeunier/Documents/projects/SecondFor/scripts/convert_CRUNCEP.R hpc:/data/gent/vo/000/gvo00074/felicien/R
# scp /home/femeunier/Documents/projects/SecondFor/data/CO2_1700_2019_TRENDYv2020.txt hpc:/data/gent/vo/000/gvo00074/felicien/R/data
